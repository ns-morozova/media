...
var Message = /*#__PURE__*/function () {
  ...
  return _createClass(Message, [{
    ...
    value: function init(pos) {
      var date = this.getDateFormat(new Date());
      this.element.innerHTML = "\n            <div style=\"display: flex; justify-content: flex-end;\">\n                <span>".concat(date, "</span>\n            </div>\n            <span>").concat(pos.message, "</span>\n            <span>[").concat(pos["long"], ",").concat(pos.lat, "]</span>\n        ");
    }
  }, {
    key: "getDateFormat",
...
var Timeline = /*#__PURE__*/function () {
  ...
  return timeline_createClass(Timeline, [{
    key: "init",
    value: function init() {
      var inpMess = this.element.querySelector('.inpmessage');
      inpMess.addEventListener('change', this.onInputMessage.bind(this));
    }
  }, {
    key: "openModal",
    value: function () {
      var _openModal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve, reject) {
                ...
                modal.querySelector('#ok').addEventListener('click', function (event) {
                ...
                modal.querySelector('#cancel').addEventListener('click', function (event) {
                  event.preventDefault();
                  modal.style.display = "none";
    ...
    key: "getPosition",
    value: function () {
      var _getPosition = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(geolocation) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 12:
              return _context2.abrupt("return", this.openModal());
            case 13:
            case "end":
    ...
    key: "onInputMessage",
    value: function onInputMessage(event) {
      var _this = this;
      event.preventDefault();
      var promise = this.getPosition(navigator.geolocation);
      promise.then(function (pos) {
        var inpMess = _this.element.querySelector('.inpmessage');
        var chat = document.createElement('div');
        chat.classList.add('containerChat');
        var mess = new Message(chat);
        pos.message = inpMess.value;
        mess.init(pos);
        _this.messages.push(mess);
        inpMess.value = '';
        _this.element.appendChild(chat);
      })["catch"](function (err) {
        alert(err.message);
      });
    }
...
var chat = new Timeline(document.querySelector('.container'));
chat.init();
